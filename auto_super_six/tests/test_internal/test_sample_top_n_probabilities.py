...
def test_sample_top_n_probabilities(
    back_odds: List[float], n: int, top_n_odds: List[int]
):
    runners = []
    ...
    selections = [
        strategy.pick_selection(runners=runners, n=n) for _ in range(NUM_SELECTIONS)
    ]
